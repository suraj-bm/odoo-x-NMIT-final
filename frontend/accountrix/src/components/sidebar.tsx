...
interface SidebarProps {
  activePage: 'dashboard' | 'contacts' | 'products' | 'cart' | 'taxes' | 'accounts' | 'purchases' | 'sales' | 'reports';
}
      ...
      <nav className="flex-1 px-4 py-6 space-y-4">
        ...
        <div>
          ...
          <div className="mt-2 space-y-1">
            ...
            <a href="/cart" className={getLinkClassName('cart')}>Cart</a>
        ...
        {status === "authenticated" ? (
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="w-full px-3 py-2 text-sm bg-white text-gray-700 border border-gray-300 rounded hover:bg-gray-50 transition-colors flex items-center justify-center"
            >
